...
def analysis_pipeline():
    """Hook used by tests to intercept analysis before DB work."""
    return run_and_dump_all(QUERIES_DIR, APP_DATA_DIR)


analysis_to_files_impl = analysis_pipeline
...
def analysis_to_files() -> Dict[str, Any]:
    ...
    written_paths = analysis_to_files_impl()
